...
class PunkBeerListViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "PunkBeer Notes"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let vc = segue.destination as? PunkBeersNotesViewController {
            if let indexPath = tableView.indexPathForSelectedRow {
...
extension PunkBeerListViewController:NSFetchedResultsControllerDelegate {
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange sectionInfo: NSFetchedResultsSectionInfo, atSectionIndex sectionIndex: Int, for type: NSFetchedResultsChangeType) {
        ...
        case .update, .move:
            fatalError("Invalid change Only .insert or .delete.")
        }
    }
